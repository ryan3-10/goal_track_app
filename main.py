...
class DetailsWindow(Screen):
    ...
    def on_pre_enter(self):
        ...
        main.add_widget(Label(text=user.get_current_goal().get_title(), font_size=30))
        main.add_widget(Label(text="Note that cycle end dates are exclusive", font_size=21))
